...
public class AdminQnaController {
	...
	// 관리자 - QnA 목록 페이지
		@GetMapping("/qnalist")
		public void adminQnaList(Criteria cri, @ModelAttribute("startDate") String startDate, @ModelAttribute("endDate") String endDate, Model model) throws Exception {

			cri.setAmount(2);

			// 관리자 - QnA 목록
			List<MyQnaVO> adQnaList = adminQnaService.adminQnaListt(cri, startDate, endDate);
